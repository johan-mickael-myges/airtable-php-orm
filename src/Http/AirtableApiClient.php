...
namespace App\Airtable\Http;

use Airtable\ORM\Client\AirtableClientInterface;
use App\Airtable\Exceptions\AirtableRecordNotFoundException;
use App\Airtable\Exceptions\CannotCreateAirtableRecordsException;
use App\Airtable\Exceptions\CannotRetrieveAirtableRecordsException;
use App\Airtable\Exceptions\InvalidAirtableResponseException;
use Symfony\Contracts\HttpClient\HttpClientInterface;
use Throwable;

class AirtableApiClient implements AirtableClientInterface
{
